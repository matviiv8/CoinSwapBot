...
var telegramBotClient = new TelegramBotClient(builder.Configuration["TelegramBot:Token"]);
await telegramBotClient.SetWebhookAsync(builder.Configuration["TelegramBot:Webhook"] + "/bot");
